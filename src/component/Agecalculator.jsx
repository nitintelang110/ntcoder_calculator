...
const givenD =new Date(dt).toLocaleDateString('en-GB')
...
const handleResult =()=>{
  ...
  alert ('Please Select Proper Date Format')
)
}
...
const handleMonths =()=>{
  ...
  return (
    ...
    <div className={styles.c_name}><h3>- - NtCoder - -</h3></div> 
        ...
        <div className={styles.inputs}><div className={styles.label}>Select Your Birth Date</div><input className={styles.inpt} type="date" name='dt' value={dt} onChange={(e)=>setDt(e.target.value)} max='8' min='8'/></div>
